//
//  BioCollectionViewCellScreen.swift
//  iPoke
//
...
class BioCollectionViewCellScreen: UIView {
...
//            informationBioImageView.heightAnchor.constraint(equalToConstant: 1500),
//
//            pokemonImageView.topAnchor.constraint(equalTo: topAnchor, constant: 10),
...
//
//            primaryTypeImage.topAnchor.constraint(equalTo: informationBioImageView.topAnchor, constant: 50),
//            primaryTypeImage.centerXAnchor.constraint(equalTo: centerXAnchor, constant: -60),
//            primaryTypeImage.heightAnchor.constraint(equalToConstant: 34),
//            primaryTypeImage.widthAnchor.constraint(equalToConstant: 90),
//
//            secundaryTypeImage.topAnchor.constraint(equalTo: informationBioImageView.topAnchor, constant: 50),
//            secundaryTypeImage.centerXAnchor.constraint(equalTo: centerXAnchor, constant: 60),
//            secundaryTypeImage.heightAnchor.constraint(equalToConstant: 34),
//            secundaryTypeImage.widthAnchor.constraint(equalToConstant: 90),
//
//            bioPokemonLabel.topAnchor.constraint(equalTo: pokemonImageView.bottomAnchor, constant: 24),
...
//            bioPokemonLabel.heightAnchor.constraint(equalToConstant: 113),
            ...
            hpLabel.topAnchor.constraint(equalTo: topAnchor, constant: 0),
            hpLabel.leadingAnchor.constraint(equalTo: leadingAnchor),
            ...
            atkLabel.leadingAnchor.constraint(equalTo: hpLabel.leadingAnchor),
            ...
            defLabel.leadingAnchor.constraint(equalTo: hpLabel.leadingAnchor),
            ...
            satkLabel.leadingAnchor.constraint(equalTo: hpLabel.leadingAnchor),
            ...
            sdefLabel.leadingAnchor.constraint(equalTo: hpLabel.leadingAnchor),
            ...
            spdLabel.leadingAnchor.constraint(equalTo: hpLabel.leadingAnchor),
            spdLabel.widthAnchor.constraint(equalToConstant: 38),
            spdLabel.heightAnchor.constraint(equalToConstant: 16),
            
            hpValueLabel.topAnchor.constraint(equalTo: topAnchor),
            ...
            hpProgressView.topAnchor.constraint(equalTo: topAnchor),
            hpProgressView.leadingAnchor.constraint(equalTo: hpValueLabel.trailingAnchor, constant: 12),
            hpProgressView.trailingAnchor.constraint(equalTo: trailingAnchor),
            ...
            atkProgressView.trailingAnchor.constraint(equalTo: hpProgressView.trailingAnchor),
            ...
            defProgressView.trailingAnchor.constraint(equalTo: hpProgressView.trailingAnchor),
            ...
            satkProgressView.trailingAnchor.constraint(equalTo: hpProgressView.trailingAnchor),
            ...
            sdefProgressView.trailingAnchor.constraint(equalTo: hpProgressView.trailingAnchor),
            ...
            spdProgressView.trailingAnchor.constraint(equalTo: hpProgressView.trailingAnchor),
