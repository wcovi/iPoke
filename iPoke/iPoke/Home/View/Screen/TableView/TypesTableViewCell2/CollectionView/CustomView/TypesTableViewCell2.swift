...
class TypesTableViewCell2: UITableViewCell {
    ...
    var dataType: [Types] = [Types(typeLabel: "Ice", typeButton: "Ice"),
                             Types(typeLabel: "Ghost", typeButton: "Ghost"),
                             Types(typeLabel: "Fairy", typeButton: "Fairy"),
                             Types(typeLabel: "Dark", typeButton: "Dark"),
                             Types(typeLabel: "Dragon", typeButton: "Dragon"),
                             Types(typeLabel: "Steel", typeButton: "Steel"),
                             Types(typeLabel: "Bug", typeButton: "Bug"),
                             Types(typeLabel: "Psychic", typeButton: "Psychic"),
                             Types(typeLabel: "Rock", typeButton: "Rock"),
    ]
