...
class TypesTableViewCell: UITableViewCell {
    ...
    var typesList: [Types] = [Types(typeLabel: "Pokedex", typeButton: "pokedex"),
                              Types(typeLabel: "Fire", typeButton: "Fire"),
                              Types(typeLabel: "Water", typeButton: "Water"),
                              Types(typeLabel: "Grass", typeButton: "Grass"),
                              Types(typeLabel: "Flying", typeButton: "Flying"),
                              Types(typeLabel: "Fighting", typeButton: "Fighting"),
                              Types(typeLabel: "Poison", typeButton: "Poison"),
                              Types(typeLabel: "Electric", typeButton: "Electric"),
                              Types(typeLabel: "Ground", typeButton: "Ground"),
                              Types(typeLabel: "Normal", typeButton: "Normal"),
