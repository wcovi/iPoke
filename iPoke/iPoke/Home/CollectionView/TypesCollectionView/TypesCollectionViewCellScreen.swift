...
//        addSubview(pokebolaImage)
    ...
    func configConstraints() {
        NSLayoutConstraint.activate([
            imageTypePokemon.topAnchor.constraint(equalTo: topAnchor),
            imageTypePokemon.leadingAnchor.constraint(equalTo: leadingAnchor),
            imageTypePokemon.trailingAnchor.constraint(equalTo: trailingAnchor),
            imageTypePokemon.bottomAnchor.constraint(equalTo: bottomAnchor),
            imageTypePokemon.widthAnchor.constraint(equalToConstant: 165),
            imageTypePokemon.heightAnchor.constraint(equalToConstant: 57),
            ...
            typeLabel.trailingAnchor.constraint(equalTo: imageTypePokemon.trailingAnchor, constant: 0),
